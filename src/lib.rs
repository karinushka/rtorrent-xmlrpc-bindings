...
trait ScgiProtocol {
    ...
    fn write_body(
        ...
        writer.write_all(headers.as_ref())?;
...
impl ScgiProtocol for UnixSocketTransport {}
...
impl Transport for UnixSocketTransport {
    ...
    fn transmit(
        ...
        UnixSocketTransport::write_body(&body, &mut stream)?;
        let response = UnixSocketTransport::read_response(&mut stream)?;
        ...
        Self {
            inner: Arc::new(ServerInner {
                endpoint: if endpoint.starts_with("http://") {
                    ...
                    Endpoint::Scgi(UnixSocketTransport { endpoint })
                },
            }),
        }
    }
